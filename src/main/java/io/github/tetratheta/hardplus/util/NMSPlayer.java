...
public class NMSPlayer {
  ...
  public static void hurtFreeze(Player player, float amount) {
    @SuppressWarnings("resource") DamageSource freeze = getNMSPlayer(player).level().damageSources().freeze();
  ...
  public static void hurtCactus(Player player, float amount) {
    ...
    @SuppressWarnings("resource") DamageSource cactus = getNMSPlayer(player).level().damageSources().cactus();
