...
public final class GetInformation {
  ...
  /**
   * Returns base package name of this library. If you don't relocate this library, it would return {@code com.github.exmserver.mol}.
   *
   * @return Package name of this library
   */
  public static @NotNull String libraryPackage() {
    // This should return 'com.github.exmserver.mol'
